...
def test_large_num_hashtag(calc_handler):
    result, error_list = calc_handler.run_single_exp("999999999999999999999999999999999999999999999.1#")
    assert result is None
    assert error_list[0].get_error_type() == "Large_Number_Error"

def test_small_num_hashtag(calc_handler):
    result, error_list = calc_handler.run_single_exp("0.0000000000000000000000000000000000000000000000000000001#")
    assert result is None
    assert error_list[0].get_error_type() == "Small_Number_Error"
